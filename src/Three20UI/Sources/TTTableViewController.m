...
- (UITableView*)tableView {
  if (nil == _tableView) {
	...
	if (TTSTYLEVAR(tableCellSeparatorColor)) {
		_tableView.separatorColor = TTSTYLEVAR(tableCellSeparatorColor);
	}
	_tableView.separatorStyle = TTSTYLEVAR(tableCellSeparatorStyle);
